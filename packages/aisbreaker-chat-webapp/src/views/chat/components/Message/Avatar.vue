...
import defaultAvatar from '@/assets/avatar-neutral.png'
//import defaultAvatar from '@/assets/avatar-techie.png'
import defaultAIAvatar from '@/assets/robot.png'
...
<template>
  ...
  <template v-else>
    <NAvatar round :src="defaultAIAvatar" />
  </template>
</template>
