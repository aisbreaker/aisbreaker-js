...
*/
export class FinalConversationResponse extends ConversationResponse {
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FinalConversationResponse.attributeTypeMap);
    }

    public constructor() {
        super();
        this.objectType = "FinalConversationResponse";
    }
}
